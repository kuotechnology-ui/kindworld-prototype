export interface User {
  ...
  organizationName?: string // For NGO users
  companyName?: string // For sponsor users
  verified?: boolean // Account verification status
  verificationStatus?: 'pending' | 'approved' | 'rejected' // NGO verification status
  verificationRequestId?: string // Reference to verification request
